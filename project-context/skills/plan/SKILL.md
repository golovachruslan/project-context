...
This skill works best when combined with Claude Code's **native Plan Mode**:
...
Save to `.project-context/plans/[name].md`. Plan verification runs automatically after saving (via skill hook).

### 7. MANDATORY: Sync Context Files

**CRITICAL: This step is NOT optional. This workflow is NOT complete until context files are updated.**
